...
算术表达式计算及栈动画展示1
![alt text](demo_png/1.png)

算术表达式计算及栈动画展示2
![alt text](demo_png/2.png)

多项式建立展示1
![alt text](demo_png/3.png)

多项式建立展示2
![alt text](demo_png/4.png)

多项式表达式计算展示
![alt text](demo_png/5.png)

多项式求值展示
![alt text](demo_png/6.png)

多项式求导展示
![alt text](demo_png/7.png)
